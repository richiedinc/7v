	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				...
				<a href="{url base='search/videos/'|cat:$categories[i].slug strip='c' value=''}" {if $category == $categories[i].CHID}class="list-group-item active"{else}class="list-group-item"{/if}>
					{$categories[i].name}
				</a>
				{/section}
			</div>
