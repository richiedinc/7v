	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				...
				<a href="{url base='search/games/'|cat:$categories[i].slug strip='c' value=''}" {if $category == $categories[i].category_id}class="list-group-item active"{else}class="list-group-item"{/if}>
