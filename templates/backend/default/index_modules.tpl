								...
								<div class="col-lg-6 col-lg-offset-3 col-md-12">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<div class="radio p-t-9">
													<input id="game_module_e" type="radio" name="game_module" value="1" {if $game_module == '1'}checked="checked"{/if} class="radio-enabled">
													<label for="game_module_e">Enabled</label>
													<input id="game_module_d" type="radio" name="game_module" value="0" {if $game_module == '0'}checked="checked"{/if} class="radio-disabled">
