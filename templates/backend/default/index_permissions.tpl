								...
								<div class="col-lg-6 col-lg-offset-3 col-md-12">
									...
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<div class="radio p-t-9">
													<input id="game_rate_user" type="radio" name="game_rate" value="user" {if $game_rate == 'user'}checked="checked"{/if} class="radio-enabled">
													<label for="game_rate_user">User</label>
													<input id="game_rate_ip" type="radio" name="game_rate" value="ip" {if $game_rate == 'ip'}checked="checked"{/if} class="radio-enabled">
