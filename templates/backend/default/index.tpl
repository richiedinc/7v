					...
					<div class="col-lg-3 col-md-6">
						<div class="tiles red m-b-10">
							<div class="tiles-body">
								...
								<div class="heading"> <a href="games.php?m=all&all=1" class="text-white"><span class="animate-number" data-value="{$games.total}" data-animation-duration="700">0</span></a> </div>								
								<div class="widget-stats">
									<div class="wrapper transparent"> 
										<span class="item-title">Active</span> 
										<a href="games.php?m=all&status=1">										
											<span class="item-count animate-number semi-bold" data-value="{$games.active}" data-animation-duration="700">0</span>
										</a>
									</div>
								</div>
								<div class="widget-stats">
									<div class="wrapper last">
										...
										<a href="games.php?m=all&status=0">
											<span class="item-count animate-number semi-bold" data-value="{$games.suspended}" data-animation-duration="700">0</span> 
										</a>
									</div>
								</div>					
							</div>			
							...
							<div class="grid-body no-border">
								<div class="row">
									<div class="col-xs-12">
										...
										<p>{$v_total} {if $v_total != 1}videos{else}video{/if}, {$a_total} {if $a_total != 1}albums{else}album{/if}, {$g_total} {if $g_total != 1}games{else}game{/if} have been added in the last 7 days</p>
